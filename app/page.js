   ...
   <div className="todayAdventureGrid">
    <div className={`daily dailyV2 dailyChallengeCard premiumDailyCard ${dailyClaimed?"dailyDone":""}`}>
     ...
     <div className="dailyChallengeInfo">
      <div className="dailyTitleRow"><b>{dailyItem.name}</b><span>{dailyClaimed?"✓ Erledigt":"Heute"}</span></div>
      ...
      <div className="dailyRewardStrip"><span>⭐ +10 Bonus</span><span>🔥 Serie sichern</span></div>
     </div>
