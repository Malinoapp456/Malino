 ...
 return <main>
  ...
  {screen==="start"&&<section className="startV2">
   <div className="hero heroV2">
    <HomeMascot/>
    <div className="speech speechV2"><span className="welcomeTag">Dein kreativer Freund</span><h1>Hallo! 👋</h1><p>Schön, dass du da bist!<br/>Was möchtest du heute malen?</p><button className="primary" onClick={()=>open(dailyItem)}>🖌️ Jetzt malen!</button></div>
    <button className="streakCard streakCardButton" onClick={()=>open(dailyItem)} aria-label="Tages-Challenge öffnen">
    ...
    <div className={`daily dailyV2 dailyChallengeCard ${dailyClaimed?"dailyDone":""}`}>
