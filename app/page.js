...
const RasterPainter=forwardRef(function RasterPainter({src,color,tool,onFeedback},ref){
 ...
 const fillAt=e=>{
  ...
  ctx.putImageData(img,0,0);onFeedback?.("ok");
 };
