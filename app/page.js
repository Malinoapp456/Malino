  ...
  {screen==="start"&&<section className="startV2">
   <div className="hero heroV2">
    ...
    <div className="streakCard">
     ...
     <div className="streakText"><b>{dailyStreak} Tage Serie</b><small>{dailyStreak===0?"Starte heute deine erste Serie!":dailyClaimed?"Heute gesichert ✓":"Schließe die Tages-Challenge ab, um die Serie zu halten."}</small></div>
