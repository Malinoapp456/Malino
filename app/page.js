...
export default function Page(){
 ...
 const numberBoards=[
  ...
  },
  {
   ...
   seeds:[
    ...
    [722,533,3],[723,717,3],[723,643,3],[555,1009,3],[888,1008,3],
 ...
 const numberRealBoards={
  ...
  rocket:{
   title:"Rakete",
   regions:[
    {id:"rocketBody",n:1,label:[250,245],d:"M250 70 C300 112 326 178 318 258 C313 311 286 354 250 392 C214 354 187 311 182 258 C174 178 200 112 250 70 Z"},
    {id:"rocketNose",n:2,label:[250,112],d:"M250 70 C277 93 296 119 307 151 C270 139 230 139 193 151 C204 119 223 93 250 70 Z"},
    {id:"windowOuter",n:3,label:[250,194],d:"M211 194 C211 169 228 151 250 151 C272 151 289 169 289 194 C289 219 272 237 250 237 C228 237 211 219 211 194 Z"},
    {id:"windowInner",n:4,label:[250,194],d:"M226 194 C226 178 236 167 250 167 C264 167 274 178 274 194 C274 210 264 221 250 221 C236 221 226 210 226 194 Z"},
    {id:"bodyStripe",n:4,label:[250,300],d:"M187 274 C226 287 274 287 313 274 C309 300 300 324 286 345 C263 353 237 353 214 345 C200 324 191 300 187 274 Z"},
    {id:"leftFin",n:2,label:[165,318],d:"M190 263 C151 282 124 326 129 374 C156 356 181 338 207 313 Z"},
    {id:"rightFin",n:2,label:[335,318],d:"M310 263 C349 282 376 326 371 374 C344 356 319 338 293 313 Z"},
    {id:"flameOuter",n:3,label:[250,422],d:"M219 365 C232 392 222 423 250 465 C278 423 268 392 281 365 C263 380 237 380 219 365 Z"},
    {id:"flameInner",n:1,label:[250,425],d:"M239 390 C246 407 243 425 250 442 C257 425 254 407 261 390 C254 396 246 396 239 390 Z"}
   ]
  },
  dino:{
   title:"Dinosaurier",
         ...
         <svg className="realNumberBoard" viewBox="0 0 500 500" aria-label={`${activeRealNumberBoard.title} Malen nach Zahlen`}>
          ...
          <g className="realNumberDetails" pointerEvents="none" fill="none" stroke="#173d78" strokeWidth="4" strokeLinecap="round">
           ...
           {numberThemeId==="rocket"&&<>
            <circle cx="250" cy="194" r="16"/><path d="M214 345 Q250 355 286 345"/>
           </>}
           {numberThemeId==="dino"&&<>
