...
export default function Page(){
 ...
 const malinoImageMasks=[
  ...
  {id:"earLeft",baseN:1,label:[257,225],d:"M222 171 C244 145 279 151 294 179 C298 211 279 243 251 251 C224 246 211 216 222 171 Z"},
  {id:"earRight",baseN:1,label:[522,230],d:"M488 178 C510 150 546 154 562 183 C568 215 548 247 519 255 C492 248 478 216 488 178 Z"},
  {id:"face",baseN:1,label:[386,272],d:"M294 151 C326 126 367 118 408 126 C461 136 493 174 500 226 C509 289 480 346 431 370 C383 394 327 383 293 346 C259 310 249 253 263 207 C269 184 279 166 294 151 Z"},

  // Tułów i ubranie
  {id:"shirtLeft",baseN:6,label:[302,432],d:"M268 378 C298 359 328 362 350 384 L341 455 C314 469 283 461 259 440 Z"},
  {id:"shirtRight",baseN:6,label:[465,432],d:"M421 382 C447 359 479 363 504 385 L516 440 C489 463 457 469 430 454 Z"},
  {id:"bib",baseN:2,label:[385,510],d:"M314 438 C352 427 414 427 454 440 L462 576 C425 600 346 601 307 577 Z"},
  {id:"shortsLeft",baseN:2,label:[330,620],d:"M303 565 C335 551 369 558 388 582 L376 704 C347 721 309 713 289 690 Z"},
  {id:"shortsRight",baseN:2,label:[438,620],d:"M385 582 C405 557 442 552 473 567 L491 691 C468 716 429 722 399 704 Z"},

  // Ręce i łapy — precyzyjniej przy ciele
  {id:"armLeft",baseN:1,label:[258,490],d:"M218 414 C243 392 275 397 294 421 C308 451 300 488 278 514 C251 538 215 530 199 502 C187 473 195 438 218 414 Z"},
  {id:"pawLeft",baseN:1,label:[286,468],d:"M251 425 C273 409 300 418 312 440 C319 462 307 488 286 499 C264 501 246 484 242 463 C240 448 243 436 251 425 Z"},
  {id:"armRight",baseN:1,label:[520,490],d:"M475 418 C497 394 531 397 553 421 C576 449 583 482 568 511 C550 538 514 540 488 518 C466 493 458 451 475 418 Z"},
  {id:"pawRight",baseN:1,label:[486,468],d:"M456 438 C468 416 496 409 518 425 C528 438 531 451 529 466 C525 488 506 503 484 499 C463 488 451 462 456 438 Z"},
  ...
  // Ogon
  {id:"tailStem",baseN:1,label:[603,590],d:"M491 538 C529 566 565 574 594 554 C619 536 623 506 635 478 C645 453 667 441 687 452 C704 466 700 490 683 507 C664 527 660 553 650 578 C633 619 591 641 551 628 C522 618 503 591 491 538 Z"},
