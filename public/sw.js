const CACHE="malino-pwa-v18-5";
const CORE=["/","/manifest.webmanifest","/icon-192.png","/icon-512.png","/apple-touch-icon.png","/malino-hero-mascot.png","/malino-hero-background.png","/sounds/click.wav","/sounds/color.wav","/sounds/success.wav","/sounds/stars.wav","/sounds/reward.wav","/sounds/streak.wav","/sounds/chest-creak.wav","/sounds/reward-boom.wav","/sounds/reward-fanfare.wav"];
